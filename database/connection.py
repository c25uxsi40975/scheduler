...
_OPERATIONAL_PREFIXES = ("希望_", "スケジュール_", "dev_希望_", "土曜シフト交換_")
...
SHEET_HEADERS = {
    "医員マスタ": ["id", "name", "account", "account_name", "email", "password_hash", "is_active", "created_at", "max_assignments", "job_rank", "can_login", "last_name", "first_name", "must_change_pw", "notify_email", "notify_calendar", "personal_calendar_id", "line_user_id", "calendar_shared_emails"],
    "外勤先マスタ": ["id", "name", "fee", "frequency", "preferred_doctors", "fixed_doctors", "excluded_doctors", "is_active", "created_at", "effort_cost", "work_hours", "time_slot", "location", "start_time", "end_time"],
    ...
    "平日外勤設定": [
        ...
        "specimen_priority", "specimen_subadmin_allowed",
    ],
    "平日スロットマスタ": [
