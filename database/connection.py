...
SHEET_HEADERS = {
    "医員マスタ": ["id", "name", "account", "account_name", "email", "password_hash", "is_active", "created_at", "max_assignments", "job_rank", "can_login", "last_name", "first_name", "must_change_pw", "notify_email", "notify_calendar", "personal_calendar_id", "line_user_id"],
